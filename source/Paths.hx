...
class Paths
{
	inline public static var SOUND_EXT = #if web "ogg" #end;
	...
	inline static public function voicesHidden(song:String)
	{
		...
		return getPath('songs/${songLowercase}/Voices.$SOUND_EXT', SOUND, 'hiddenContent');
	}
	...
	inline static public function voicesEasy(song:String)
	{
		...
		return 'songs:assets/songs/${songLowercase}/Voices-easy.$SOUND_EXT';
	}
	...
	inline static public function instHidden(song:String)
	{
		...
		return getPath('songs/${songLowercase}/Inst.$SOUND_EXT', SOUND, 'hiddenContent');
	}
	...
	inline static public function getSparrowAtlas(key:String, ?library:String,?unused:Bool)
	{
		return FlxAtlasFrames.fromSparrow(image(key, library, true), file('images/$key.xml', library));
	}

	inline static public function getAlphabetAtlas(key:String, ?library:String)
	{
		return FlxAtlasFrames.fromSparrow(image(key, library, true), file('images/$key.xml', library));
	}
